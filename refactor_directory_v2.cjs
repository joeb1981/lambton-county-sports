                ...
                <div className="space-y-4">
                  <div className="space-y-1.5">
                    ...
                    <Select value={selectedSport || "all"} onValueChange={(v) => setSelectedSport(v === "all" ? "" : v)}>
                      <SelectTrigger className="bg-slate-50 border-slate-200 rounded-lg w-full text-sm">
...
console.log('Successfully refactored Directory to un-squish cards and move filters to sidebar');
